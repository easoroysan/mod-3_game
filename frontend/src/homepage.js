class HomePage {
	...
	newUserForm() {
		...
		form.addEventListener('submit', (e) =>
			this.createUser(e, usernameInput, passwordInput, passwordConfirm)
		)
	...
	loginForm(name) {
		...
		form.addEventListener('submit', (e) =>
			this.userPage(e, usernameInput, passwordInput)
		)
	...
	instructions() {
		...
		let li4 = c('li')
		li4.innerText =
			'health will only increase by 1 each level up to a maximum of 5'
		let li5 = c('li')
		li5.innerText =
			'every shield left at the end of a level will reduce your time by 100'
		let li6 = c('li')
